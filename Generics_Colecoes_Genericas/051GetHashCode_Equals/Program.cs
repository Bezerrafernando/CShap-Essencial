...
var pessoa1 = new Pessoa(123456, "Dbezerra");
var pessoa2 = new Pessoa(123456, "Dbezerra");
var pessoa3 = new Pessoa(987654, "Dbezerra");

Console.WriteLine("pessoa1 -> Cpf = 123456 Nome = Dbezerra");
Console.WriteLine("pessoa2 -> Cpf = 123456 Nome = Dbezerra");
Console.WriteLine("pessoa3 -> Cpf = 987654 Nome = Dbezerra");
